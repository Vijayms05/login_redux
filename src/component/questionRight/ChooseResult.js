...
import {CircleLeft, CircleRight,FeedbackIcon} from '../../assets/images/index'
    ...
    <div className=" m-auto">{/*tl-rt-qst d-grid */}
        <div className="in-rt-qst">   
            ...
            <div className='text-center mt-2'>
                <p style={{color:'#4DD188'}}  >Your answer is correct Score : 1</p>
            </div>
            <div className="pre-nxt-skp mt-3">               
                ...
                <div className="d-flex text-center">
                    <Button className="ans-exp-btn ms-2" >   
                        Answer Explanation
                    </Button>
                    <Button className="pre-btn ms-2">
