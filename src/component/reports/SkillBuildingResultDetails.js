    ...
    return (
        <div className="py-md-4 mt-5 mt-md-0 bill-rit">
            <Col md={12} xs className="baselinereport">
                ...
                <Row className="justify-content-md-center justify-content-sm-center">{/*div className="d-lg-flex" className="p-md-0 in-bs-ln"*/}
                    <Col xs={12} sm={12} md={12} lg={10} xl={8}>
                        ...
                        <h4 className="f1-16 text-center mb-5 mb-lg-3">Chapter wise Score</h4>

                        <div className="text-start mb-3 mt-5 mt-md-4 mt-lg-3">
                            <h4 className="f1-17 my-3" style={{ color: '#003866' }}>Chapter wise Score</h4>
                            <Row>
                    ...
                    <Col xs={12} sm={10} md={10} lg={6} xl={4}  >{/*className="mt-2 skill-smry" */}
                        <Card className=" mb-3 mt-2 p-1 base-card-report text-center">
                            ...
                            <Card.Body
                            >{/*className="skil-sum-tit mb-2 mt-3" */}
