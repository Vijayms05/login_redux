                        ...
                        props.data.map((item, index) => {
                            return (
                                <Accordion.Item eventKey={index} className="ac-itm">
                                    <Accordion.Header className="acc-h1">{item[0].subject.subject.name}</Accordion.Header>
                                    <Accordion.Body className="p-0">
                                        {item.map((list, index) => {
                                            return <Row>
                                                <Col>
                                                    {list.topic.chapter.name + " - " + list.topic.name}
                                                </Col>
                                            </Row>
                                        })}
                                        <Table>
                                            <tbody>
                                                <tr>
                                                    <td></td>
                                                    {/* <td>{item[0].subject.subject.name}</td>
                                                <td>{item[0].topic.chapter.name}</td> */}
                                                    <td>{item.map((list, index) => {
                                                        return list.topic.chapter.name + " - " + list.topic.name
                                                    })}</td>
